...
#else
#define ILI9341_W 321
#define ILI9341_H 241
#endif
...
#define LCD_DC_Clr()   GPIO_ResetBits(GPIOD,GPIO_Pin_9)//DC
#define LCD_DC_Set()   GPIO_SetBits(GPIOD,GPIO_Pin_9)
 		     
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOB,GPIO_Pin_12)//CS
#define LCD_CS_Set()   GPIO_SetBits(GPIOB,GPIO_Pin_12)

#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOD,GPIO_Pin_8)//BLK
#define LCD_BLK_Set()  GPIO_SetBits(GPIOD,GPIO_Pin_8)


void ILI9341_init(void);//初始化GPIO
