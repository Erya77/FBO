...
#define ST7789V_W 128
#define ST7789V_H 160

#else
#define ST7789V_W 320
#define ST7789V_H 256
#endif



//-----------------OLED端口定义---------------- 
  //PBout(13);//SCL (LCD_SPI_SCK)
  //PBout(15);//SDA (LCD_SPI_MOSI)
	//PBout(14);//RES (LCD_SPI_REST)   ||RST
	//PDout(9); //DC  (LCD_DC)         ||RS
  //PBout(12);//CS  (LCD_SPI_NSS)
  //PDout(8); //BLK (LCD_BLK)
...
#define OLED_BLK_Clr()  GPIO_ResetBits(GPIOD,GPIO_Pin_8)//BLK
#define OLED_BLK_Set()  GPIO_SetBits(GPIOD,GPIO_Pin_8)
